...
//                                    ])
    ...
    private func setCollectionViewLayout() {
        ...
        flowLayout.scrollDirection = .horizontal // 수평방향 스크롤
        ...
        flowLayout.minimumLineSpacing = 0 // 셀 사이 간격 최소값 0으로 설정
    ...
    var scrollview: UIScrollView = {
        ...
        // view.backgroundColor = UIColor.red.withAlphaComponent(0.5) // 스크롤뷰 범위알기 위함
        return view
    }()
    ...
    // box 객체를 두번이상 선언하지 않고 한번에 해결하는법은..?
    var box2: UIView = {
        let view = UIView()
        view.backgroundColor = UIColor.black.withAlphaComponent(0.2)
        view.layer.cornerRadius = 20
